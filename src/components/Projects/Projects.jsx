...
const Projections = () => {
  ...
  return (
    <section className="w-screen h-screen bg-Dark pro:w-0 pro:h-0">
      <div className="Text w-screen h-40  flex justify-center items-center overflow-hidden  pro:w-0 pro:h-0">
        <motion.h2
          variants={{
            initial: { y: 160 },
          ...
          className="font-Display tracking-Projects w-screen text-9xl text-center  pro:w-0 pro:h-0 hover:tracking-Projects2 cursor-pointer text-white"
        >
          Projects
        </motion.h2>
      </div>
      <div className="blow w-screen h-60  pro:w-0 pro:h-0">
        <>
          <motion.svg
            width="1246"
            height="366"
            ...
            ref={sec}
            className="h-blow  pro:w-0 pro:h-0"
          >
